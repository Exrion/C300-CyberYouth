...
import DataService from "../services/track.service";
    ...
    return (
      <div>
        ...
        <div class="grid xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 grid-flow-row gap-4 w-12/12">
          {items.map((item) => (
            <div class="p-4 h-auto group w-auto flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-gray-100">
              <div class="flex flex-col justify-between p-4 leading-normal mt-12 group-hover:hidden grow flex-1">
                ...
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  Track Provider: {item.trackProvider}
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  Track Link: {item.trackLink}
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  Track Tags: {item.trackTags}
                </p>
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  Track Lemons: {item.trackLemons}
                </p>
              </div>
