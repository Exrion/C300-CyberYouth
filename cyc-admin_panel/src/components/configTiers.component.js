                                        ...
                                        <li class="group rounded-xl shadow w-full h-full">
                                            <div class="grid grid-cols-3">
                                                <div class="col-span-1">
                                                    <img src={item.tierIcon} class="rounded-l-xl h-full"></img>
                                                </div>
                                                <div class="col-span-2 p-5 grid grid-rows-5">
                                                    ...
                                                    <div class="row-span-1 flex justify-center">
                                                        <Link to={"/tiers/" + item.id} class="focus:outline-none text-white bg-green-700 hover:bg-green-800 transition ease-in-out focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">
                                                            Edit
                                                        </Link>
